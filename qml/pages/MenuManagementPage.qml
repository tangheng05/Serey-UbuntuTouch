...
/*
 * CRUD for the current community's navbar/menu items
 * (custom_menu_route.js, /custom-menu). Reorder via up/down buttons calling
 * update-positions; create/edit via a Dialog (title + url + icon name).
 */
Page {
    id: page
